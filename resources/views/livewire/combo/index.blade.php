            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border p-2 text-center space-x-2">
                        <x-button wire:click="openModal({{ $p->id }})" class="text-blue-600 bg-transparent hover:underline p-0">Edit</x-button>
                        <x-button wire:click="delete({{ $p->id }})" class="text-red-600 bg-transparent hover:underline p-0">Hapus</x-button>
                    </td>
                </tr>
                @empty
                <tr>

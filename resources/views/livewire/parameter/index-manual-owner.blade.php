                    ...
                    <tr>
                        ...
                        <th wire:click="sortBy('owner_name')"
                            ...
                            <div class="group inline-flex items-center gap-x-2 hover:text-gray-200">
                                Parent
                                <i
                                    class="fas {{ $this->getSortIcon('owner_name') }} text-gray-300 group-hover:text-gray-200 transition-all duration-200"></i>
                            </div>
                        </th>
                        <th wire:click="sortBy('owner_name')"
                            class="px-4 py-3 text-left text-sm font-medium text-white uppercase tracking-wider border-b border-[rgb(0,95,160)] cursor-pointer group transition-all duration-200">
    ...
    <div class="modal-body p-6 space-y-6">
        ...
        <div class="space-y-1">
            ...
            <select wire:model="parent_id"
                class="w-full rounded-lg border border-gray-300 bg-white text-gray-900 text-sm shadow-sm transition-all duration-300
                focus:border-[rgb(0,111,188)] focus:ring-[rgb(0,111,188)]
                @error('parent_id') border-red-500 @enderror select2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="space-y-1">
                <label class="form-label font-medium text-gray-700">
                    Data Id <span class="text-red-500">*</span>
                </label>

                <input type="text" wire:model="owner_name"
                    class="w-full rounded-lg border border-gray-300 p-2 bg-white text-gray-900 text-sm shadow-sm transition-all duration-300
                    focus:border-[rgb(0,111,188)] focus:ring-[rgb(0,111,188)]
                    @error('owner_name') border-red-500 @enderror"
                    placeholder="Masukkan Data Id">
            ...
            <div class="space-y-1">
                <label class="form-label font-medium text-gray-700">
                    Data En <span class="text-red-500">*</span>
                </label>

                <input type="text" wire:model="owner_name_1"
                    class="w-full rounded-lg border border-gray-300 p-2 bg-white text-gray-900 text-sm shadow-sm transition-all duration-300
                    focus:border-[rgb(0,111,188)] focus:ring-[rgb(0,111,188)]
                    @error('owner_name_1') border-red-500 @enderror"
                    placeholder="Masukkan Data En">

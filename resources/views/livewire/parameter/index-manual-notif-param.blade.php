                    ...
                    <form wire:submit="save">
                        <div class="modal-body p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-3">
                                    <label class="form-label font-medium text-gray-700">Jam<span
                                            class="text-red-500">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label class="form-label font-medium text-gray-700">Hari<span
                                            class="text-red-500">*</span></label>
                                    <input type="number" wire:model="param_int_1"
                                        class="w-full rounded-lg border p-2 border-gray-300 bg-white text-gray-900 focus:border-[rgb(0,111,188)] focus:ring-[rgb(0,111,188)] shadow-sm transition-all duration-300 @error('param_int_1') border-red-500 @enderror"
                                        placeholder="Masukkan data...">
                                    @error('param_int_1')
                                        <div class="text-red-600 text-sm mt-1 animate-shake">{{ $message }}</div>
                                    @enderror

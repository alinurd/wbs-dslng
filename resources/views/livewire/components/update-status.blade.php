                ...
                <div>
                    ...
                    @if ($file_upload)
                        <div class="mt-3">
                            ...
                            <div class="mt-1 flex items-center justify-between bg-gray-50 px-3 py-2 rounded-lg">
                                <div class="flex items-center">
                                    <i class="fas fa-file mr-2 text-gray-400"></i>
                                    <span class="text-sm text-gray-600">{{ $file_upload->getClientOriginalName() }}</span>
                                </div>
                                <button 
                                    type="button" 

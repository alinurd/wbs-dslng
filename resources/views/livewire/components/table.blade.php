...
@endphp
<div class="border border-gray-200 rounded-lg bg-white shadow-sm transition-all duration-300">
                    ...
                    <td class="px-4 py-3 whitespace-nowrap text-center border-b border-gray-100">
                        <div class="flex justify-center gap-1">
                            ...
                            @else
                                ...
                                @else
                                    <div class="relative inline-block text-left" x-data="{ open: false }" style="">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            class="origin-top-right absolute right-0 mt-1 w-48 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-[10000]"

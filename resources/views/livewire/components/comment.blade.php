...
@if ($show)
    <div class="fixed inset-0 z-50 overflow-y-auto animate-fade-in" style="background-color: rgba(0,0,0,0.5)">
        <div class="flex min-h-full items-center justify-center p-4">
            <div
                class="modal-content bg-white rounded-lg shadow-xl w-full max-w-6xl transform transition-all duration-300 scale-95 animate-scale-in">
                <!-- Header -->
                <div
                ...
                <div class="modal-body p-0 max-h-[80vh] overflow-hidden flex">
                    ...
                    <div class="w-2/3 flex flex-col">
                        ...
                        <!-- Messages Container -->
                        <div class="flex-1 p-6 overflow-y-auto bg-gray-50" id="chatMessages" wire:poll.1s="loadMessages"
                                    ...
                                    @foreach ($messages as $message)
                                        <div class="flex {{ $message['is_own'] ? 'justify-end' : 'justify-start' }}">
                                            ...
                                            {{ $message['is_own']
                                                ...
                                                <!-- Di bagian chat messages, perbaiki seperti ini: -->

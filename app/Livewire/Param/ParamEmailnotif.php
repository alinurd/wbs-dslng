...
class ParamEmailNotif extends Component
{
    use WithPagination;

    public $title = "Email Notifikasi";
    public $filterKelompok = "notif-email";
    public $search = '';
    public $perPage = 10;
    ...
    protected $messages = [
        ...
        'data.required' => 'Data Id wajib diisi!',
    ...
    public function render()
    {
        ...
        return view('livewire.parameter.index-manual-notif-email', [
            'combos' => $combos,
            'title' => "Combo",
    ...
    {
        $this->reset([
            // 'comboId', 'data_id' , 'data', 'is_active', 'updateMode'
        ]);
        $this->resetErrorBag();
    }
}